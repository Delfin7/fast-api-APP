...
async def products(suppliers_data: Suppliers):
    ...
    cursor = await app.db_connection.execute(f"INSERT INTO Suppliers  VALUES  ({next_id}, {suppliers_data.CompanyName},{suppliers_data.ContactName},{suppliers_data.ContactTitle},{suppliers_data.Address},{suppliers_data.City}, NULL,{suppliers_data.PostalCode},{suppliers_data.Country},{suppliers_data.Phone},NULL,NULL);").fetchall()
    return cursor
